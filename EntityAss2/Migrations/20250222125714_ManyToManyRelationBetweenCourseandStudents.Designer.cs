...
namespace EntityAss2.Migrations
{
    ...
    [Migration("20250222125714_ManyToManyRelationBetweenCourseandStudents")]
    partial class ManyToManyRelationBetweenCourseandStudents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityAss1.Models.NewStd_Course", b =>
                {
                    b.HasOne("EntityAss1.Models.NewCourse", "Course")
                        .WithMany("Std_Courses")
                        .HasForeignKey("Course_Id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("EntityAss1.Models.NewStudent", "Student")
                        .WithMany("Std_Courses")
